...
public class AlgProvider {
    ...
    private final String natHostAddress;
    ...
    public AlgProvider(ProxyController proxyController) {
        ...
        this.natEnabled = this.proxyController.getConfiguration().getProperty("talk.rtp.alg.nat.enabled", "false").equals("true");
        this.natHostAddress = this.proxyController.getConfiguration().getProperty("talk.rtp.alg.nat.host", "0.0.0.0");
    ...
    public String getListenHostAddress() {
        return this.listenHostAddress;
    }

    public String getAccessibleHostAddress() {
        if (!this.natEnabled) {
            return this.listenHostAddress;
        } else {
            return this.natHostAddress;
        }
    }
