...
public class SipSessionDao extends DatabaseObject {
    ...
    public SipExtensionDao getCallerExtensionDao() {
        return this.getDaoField(SipExtensionDao.class, "CallerExtensionObjectId");
    }
    
    public void setCallerExtensionDao(SipExtensionDao dao) {
        this.setDaoField("CallerExtensionObjectId", dao);
    }
    
    public SipExtensionDao getCalleeExtensionDao() {
        return this.getDaoField(SipExtensionDao.class, "CalleeExtensionObjectId");
    }
    
    public void setCalleeExtensionDao(SipExtensionDao dao) {
        this.setDaoField("CalleeExtensionObjectId", dao);
    }
    ...
    public Date getCancelDate() {
        return this.getDateField("CancelDate");
    }
    
    public void setCancelDate(Date date) {
        this.setDateField("CancelDate", date);
    }
